...
public class FocusElementLineTest {
    ...
    public void prepare() throws Exception {
        ...
        testSubject = new FocusElementLine(accessibilityNodeInfoMock, accessibilityNodeInfoMock, paintsStub, viewMock);
    }
    ...
    public void drawLineCallsCorrectPrivateMethod() throws Exception {
        ...
        verifyPrivate(lineSpy, times(1)).invoke("drawConnectingLine", anyInt(), anyInt(), anyInt(), anyInt(), any(Paint.class), any(Canvas.class));
    }
