...
public class LayoutParamGeneratorTest {
  ...
  public void generatesLayoutParams() throws Exception {
    ...
    try (MockedConstruction<WindowManager.LayoutParams> layoutParamsConstructionMock = Mockito.mockConstruction(WindowManager.LayoutParams.class, (mockLayoutParams, context) -> {
      ...
      assertEquals(WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE
              ...
              | WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS, args.get(3));
